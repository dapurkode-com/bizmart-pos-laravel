       ...
       <div class="col-sm-12">
           <div class="invoice p-3 mb-3">
               <div class="row">
                   <div class="col-sm-12">
                        ...
                        <small class="float-right">
                            {{ $otherExpense->updated_at->isoFormat('DD/MM/Y') }}
                        </small>
                        </h4>
                   </div>
               </div>
               <div class="row invoice-info">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <input id="buy_id" type="hidden" name="buy_id" value="{{$otherExpense->uniq_id}}">
                        <table class="table table-striped" id="tbIndex">
                            ...
                            <tbody>
                                @foreach ($otherExpense->details as $key => $detail)
                                @php
                                    $key++;
                                @endphp
                                    <tr>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right">{{ number_format($otherExpense->summary) }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
