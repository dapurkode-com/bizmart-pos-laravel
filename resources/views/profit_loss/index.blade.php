                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{ number_format($sellSummary) }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="2">Potongan Penjualan</td>
                            <td class="text-right" style="border-bottom: 2px solid black;">0</td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{ number_format($stockValueOld) }}</td>
                            <td></td><td></td>
                        </tr>
                        <tr>
                            <td colspan="1">Pembelian</td>
                            <td class="text-right" style="border-bottom: 2px solid black;" >{{ number_format($buySummary) }}</td>
                            <td></td><td></td>
                        </tr>
                        <tr>
                            <td colspan="2">Barang Tersedia Dijual</td>
                            <td class="text-right">{{ number_format($buySummary + $stockValueOld) }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="2">Persedian Barang Akhir</td>
                            <td class="text-right" style="border-bottom: 2px solid black;">{{ number_format($stockValueNew) }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <th colspan="3">HPP</th>
                            <td class="text-right" style="border-bottom: 2px solid black;">{{ number_format($buySummary + $stockValueOld - $stockValueNew) }}</td>
                        </tr>
                        <tr>
                            <th colspan="3">LABA KOTOR</th>
                            <td class="text-right">{{ number_format($sellSummary - ($buySummary + $stockValueOld - $stockValueNew)) }}</td>
                        </tr>
                        <tr>
                            <td colspan="4"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{ number_format($oe->summary) }}</td>
                            <td></td>
                        </tr>
                        @endforeach
                        <tr>
                            ...
                            <td class="text-right" style="border-bottom: 2px solid black;">{{ number_format($otherExpenseSummary->sum('summary')) }}</td>
                        </tr>
                        <tr>
                            <th colspan="3">LABA/RUGI BERSIH</th>
                            <td class="text-right">{{ number_format($sellSummary - ($buySummary + $stockValueOld - $stockValueNew) - $otherExpenseSummary->sum('summary')) }}</td>
                        </tr>
